...
def main():
    ...
    from espnet2.speechlm.trainer.deepspeed_trainer_naive import DeepSpeedTrainerNaive
    trainer = DeepSpeedTrainerNaive(**trainer_kwargs)
    ...
    #     # 这个也是分布式训练框架。titan是Meta开源的分布式训练库。
