...
# data_sets="dev-clean test-clean dev-other test-other"

# 全集
# data_sets="dev-clean test-clean dev-other test-other train-clean-100 train-clean-360 train-other-500"

# 训练集
data_sets="train-clean-100 train-clean-360 train-other-500"
